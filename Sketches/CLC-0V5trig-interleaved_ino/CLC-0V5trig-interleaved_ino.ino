...
//#define ADCSELECT B00100000 // CLC: mudar para AREF externo: 2k2 p/ +5V e 300R p/ GND: 600mV de referência (aumenta resolução p/ ondas de pico <0.6V)
...
//ACSR = B01011011; // enable AC, AIN0=1.1V, ACO=off, ClearPendindInt, ACintEnable,ACInputCapt=Disabled, rising edge do comparador=falling edge do meu sinal
ACSR = B00011011; // enable AC, AIN0 ext, ACO=off, ClearPendindInt, ACintEnable,ACInputCapt=Disabled, rising edge do comparador=falling edge do meu sinal
